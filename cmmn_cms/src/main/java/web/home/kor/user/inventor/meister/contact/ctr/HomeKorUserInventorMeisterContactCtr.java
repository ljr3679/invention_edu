package web.home.kor.user.inventor.meister.contact.ctr;
...
public class HomeKorUserInventorMeisterContactCtr extends CMSMappingHandler {
	
	@Resource(name="homeKorUserInventorMeisterContactSvc")
	private HomeKorUserInventorMeisterContactSvc homeKorUserInventorMeisterContactSvc; 
	...
	public void editAct(
		...
		vo.setTabPos("8");
		homeKorUserInventorMeisterContactSvc.insertHomeKorUserInventorMeisterContact(vo);
