package web.home.kor.user.inventor.patent.contact.ctr;
...
public class HomeKorUserInventorPatentContactCtr extends CMSMappingHandler {
	
	@Resource(name="homeKorUserInventorPatentContactSvc")
	private HomeKorUserInventorPatentContactSvc homeKorUserInventorPatentContactSvc; 
	...
	public void editAct(
		...
		vo.setTabPos("10");
		homeKorUserInventorPatentContactSvc.insertHomeKorUserInventorPatentContact(vo);
