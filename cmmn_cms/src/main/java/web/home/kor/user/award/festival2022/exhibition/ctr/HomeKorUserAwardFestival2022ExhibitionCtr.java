package web.home.kor.user.award.festival2022.exhibition.ctr;
...
@Controller
@RequestMapping(value="/award/festival2022/exhibition/")
public class HomeKorUserAwardFestival2022ExhibitionCtr extends CMSMappingHandler {
	
	@Resource(name="homeKorUserAwardFestival2022ExhibitionSvc")
	private HomeKorUserAwardFestival2022ExhibitionSvc homeKorUserAwardFestival2022ExhibitionSvc; 
	...
	public void index(
		...
		if(stringUtil.isEmpty(vo.getSearchValue1())) vo.setSearchValue1("2022");
		...
		switch (vo.getTabPos2()) {
			case "1": 
				...
				EgovMap resultData = homeKorUserAwardFestival2022ExhibitionSvc.selectHomeKorUserAwardFestival2022ExhibitionBasicData(vo);
	...
	public String list(
		...
		setPaging(vo, model, new PagingDataInterface() {
			...
			public Object[] callData() throws Exception {
				...
				List<?> resultList = homeKorUserAwardFestival2022ExhibitionSvc.selectHomeKorUserAwardFestival2022ExhibitionList(vo);
				Integer totalCnt = homeKorUserAwardFestival2022ExhibitionSvc.selectHomeKorUserAwardFestival2022ExhibitionListCnt(vo);
	...
	public void edit(
		...
		if(stringUtil.isNotEmpty(vo.getIdx())) {
			...
			EgovMap resultData = homeKorUserAwardFestival2022ExhibitionSvc.selectHomeKorUserAwardFestival2022Exhibition(vo);
			model.addAttribute("resultData", resultData);
			EgovMap param = new EgovMap();
			param.put("category", "C037pd467T");
