package web.home.kor.user.inventor.youth.contact.ctr;
...
public class HomeKorUserInventorYouthContactCtr extends CMSMappingHandler {
	
	@Resource(name="homeKorUserInventorYouthContactSvc")
	private HomeKorUserInventorYouthContactSvc homeKorUserInventorYouthContactSvc; 
	...
	public void editAct(
		...
		vo.setTabPos("7");
		homeKorUserInventorYouthContactSvc.insertHomeKorUserInventorYouthContact(vo);
