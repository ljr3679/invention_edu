package web.home.kor.user.award.festival2023.exhibition.ctr;
...
@Controller
@RequestMapping(value="/award/festival2023/exhibition/")
public class HomeKorUserAwardFestival2023ExhibitionCtr extends CMSMappingHandler {

	@Resource(name="homeKorUserAwardFestival2023ExhibitionSvc")
	private HomeKorUserAwardFestival2023ExhibitionSvc homeKorUserAwardFestival2023ExhibitionSvc; 
	...
	public void index(
		...
		switch (vo.getTabPos2()) {
			case "1": 
				...
				EgovMap resultData = homeKorUserAwardFestival2023ExhibitionSvc.selectHomeKorUserAwardFestival2023ExhibitionBasicData(vo);
	...
	public String list(
		...
		setPaging(vo, model, new PagingDataInterface() {
			...
			public Object[] callData() throws Exception {
				...
				List<?> resultList = homeKorUserAwardFestival2023ExhibitionSvc.selectHomeKorUserAwardFestival2023ExhibitionList(vo);
				Integer totalCnt = homeKorUserAwardFestival2023ExhibitionSvc.selectHomeKorUserAwardFestival2023ExhibitionListCnt(vo);
	...
	public void edit(
		...
		if(stringUtil.isNotEmpty(vo.getIdx())) {
			...
			EgovMap resultData = homeKorUserAwardFestival2023ExhibitionSvc.selectHomeKorUserAwardFestival2023Exhibition(vo);
			model.addAttribute("resultData", resultData);
			EgovMap param = new EgovMap();
			param.put("category", "C037pd467T");
