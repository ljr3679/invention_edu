package web.home.kor.user.award.festival2024.exhibition.ctr;
...
@Controller
@RequestMapping(value="/award/festival2024/exhibition/")
public class HomeKorUserAwardFestival2024ExhibitionCtr extends CMSMappingHandler {

	@Resource(name="homeKorUserAwardFestival2024ExhibitionSvc")
	private HomeKorUserAwardFestival2024ExhibitionSvc homeKorUserAwardFestival2024ExhibitionSvc; 
	...
	public void index(
		...
		switch (vo.getTabPos2()) {
			case "1": 
				...
				EgovMap resultData = homeKorUserAwardFestival2024ExhibitionSvc.selectHomeKorUserAwardFestival2024ExhibitionBasicData(vo);
	...
	public String list(
		...
		setPaging(vo, model, new PagingDataInterface() {
			...
			public Object[] callData() throws Exception {
				...
				List<?> resultList = homeKorUserAwardFestival2024ExhibitionSvc.selectHomeKorUserAwardFestival2024ExhibitionList(vo);
				Integer totalCnt = homeKorUserAwardFestival2024ExhibitionSvc.selectHomeKorUserAwardFestival2024ExhibitionListCnt(vo);
	...
	public void edit(
		...
		if(stringUtil.isNotEmpty(vo.getIdx())) {
			...
			EgovMap resultData = homeKorUserAwardFestival2024ExhibitionSvc.selectHomeKorUserAwardFestival2024Exhibition(vo);
			model.addAttribute("resultData", resultData);
			EgovMap param = new EgovMap();
			param.put("category", "C037pd467T");
