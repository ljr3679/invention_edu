...
public abstract class AbstractExcelPOIView extends AbstractView {
    ...
    protected final void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception {
    	...
    	try {
    		...
    		String password = String.valueOf(model.get("password"));
    		
    		if(password == null || (password != null && password.equals("") || (password != null && password.equals("null")))) {
     ...
     */
    protected abstract void buildExcelDocument(Map<String, Object> excelMap, Workbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception;
}