    ...
    function html5Upload() {	
    	...
    	sUploadURL = '/sm/editor/single/fileUpload.do' //upload URL
	...
	/*alert("[가이드]사진 업로더할 서버URL셋팅이 필요합니다.-onAjaxError");*/
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 	    	...
 	    	sUrl : '/sm/editor/multi/fileUpload.do',
 	    	sCallback : '/editor/SmartEditor2/photo_uploader/popup/callback.html',
