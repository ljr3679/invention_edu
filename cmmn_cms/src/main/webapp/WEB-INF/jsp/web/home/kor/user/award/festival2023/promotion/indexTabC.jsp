...
<div class="sub_cont">
	<div class="com_cont ft_c1">
		<div class="title_cont">
			<div class="box">
				<div class="img_box">
					<img src="images/tit_area_bg_02.jpg" alt="">
				</div>
				<div class="title_area">
					<div class="title_inner">
						<div class="title">
							<p><img src="images/promotion_top_txt.png" alt=""></p>
							<span class="ft_c">'발명교육센터'</span>를 소개합니다!
						</div>
					</div>
			...
			<ul class="list">
							...
							<ul class="list">
								<li>
									<div class="area">
										...
										<div class="box_img">
											<div class="inner_img">
												<img src="/images/home/kor/user/award/festival2023/promotion_img01.jpg" alt="">
											</div>
										</div>
									</div>
								</li>
				...
				<li>
					<div class="box">
						...
						<div class="text">도서‧벽지 등 발명교육을 접하기 어려운 지역 또는 지역아동센터 등 우선 지원이 필요한 청소년 대상 발명교육 전문강사가 직접 방문하여 체험‧실습 위주의 발명교육을 제공하는 프로그램입니다.</div>
							...
							<div class="step_area">
								<ul class="list">
									<li class="step01">
										<div class="step_box">
											<div class="box">
												<div class="txt"><span class="step">STEP 1</span>신청 ‧ 접수 <br>(1월~3월)
												</div>
											</div>
										</div>
										<div class="txt_box">
											<div class="txt">찾아가는 발명체험교실<br> 신청·접수</div>
										</div>
									</li>
									<li class="step02">
										<div class="step_box">
											<div class="box">
												<div class="txt"><span class="step">STEP 2</span>기관 선정 및 <br>
													교육일정 확정<br>(3월~4월)
													</div>
											</div>
										</div>
										<div class="txt_box">
											<div class="txt">신청기관 운영형태 및 교육환경 등을 복합적으로 고려하여 기관 선정 후, 발명교육전문강사와 교육일정 확정
											</div>
										</div>
									</li>
									<li class="step04">
										<div class="step_box">
											<div class="box">
												<div class="txt"><span class="step">STEP 3</span>교육운영 <br>(4월~11월)
												</div>
											</div>
										</div>
										<div class="txt_box">
											<div class="txt">방문형 교육운영</div>
										</div>
									</li>
								</ul>
							</div>
				...
				<li>
					<div class="box">
						<div class="title"><span class="ft_c1">어떤 기관</span>이 신청할 수 있나요?</div>
						<div class="imp">‘청소년 관련 기관 어디든 신청 가능합니다.’</div>
						<div class="text">그 중 도서‧벽지 및 농‧어촌학교 소규모 학교와 지역아동센터, 보육원 등 평소에 발명교육을 접하기 어려운 청소년 관련 기관을 우선으로 선정‧지원합니다.
						</div>
					</div>
				</li>
				<li>
