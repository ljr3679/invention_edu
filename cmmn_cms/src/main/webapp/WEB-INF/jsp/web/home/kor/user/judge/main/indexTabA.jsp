...
<div class="bbs_list">
	<c:forEach items="${resultList}" var="list" varStatus="status">
		<div class="list_pac">
			...
			<div class="click-area"><!-- #fa4545 -->
				<span title="좋아요 수" style="font-size:13px;font-weight:500;color:#fa4545;" id="like_count_${list.no}"><c:out value="${list.likeCnt}" /></span>
				<!-- 선택전 버튼 -->
				<button class="heart" title="좋아요" onclick="fn_like('${list.no}','${usrSession.no}',this);">
					<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30px" height="27px">
						<c:choose>
							<c:when test="${likedData.tbInventExamRef eq list.no}">
								<image id="heart_${list.no}" x="0px" y="0px" width="30px" height="27px" xlink:href="data:img/png;base64," />
							</c:when>
							<c:otherwise>
								<image id="heart_${list.no}" x="0px" y="0px" width="30px" height="27px" xlink:href="data:img/png;base64," />
							</c:otherwise>
						</c:choose>
						
						<%-- <image id="heart_${list.no}" x="0px" y="0px" width="30px" height="27px" xlink:href="data:img/png;base64," /> --%>
						<!-- data:img/png;base64, -->
					</svg>
					<p>좋아요</p>
				</button>
			</div>
