	...
	<form:hidden path="searchValue10"/>
		...
		<c:choose>
			<c:when test="${vo.tabPos2 eq '1'}">
				<div class="list_wrap">
					<%@ include file="/WEB-INF/jsp/web/home/kor/user/award/festival2023/exhibition/indexTabA.jsp" %>	
				</div>
			</c:when>
			<c:when test="${vo.tabPos2 eq '2'}">
				<div class="list_wrap">
					<%@ include file="/WEB-INF/jsp/web/home/kor/user/award/festival2023/exhibition/indexTabB.jsp" %>	
				</div>
			</c:when>
			<c:when test="${vo.tabPos2 eq '3'}">
				<div class="list_wrap">
					<%@ include file="/WEB-INF/jsp/web/home/kor/user/award/festival2023/exhibition/indexTabC.jsp" %>
				</div>
			</c:when>
			<c:when test="${vo.tabPos2 eq '4'}">
				<div class="list_wrap">
					<%@ include file="/WEB-INF/jsp/web/home/kor/user/award/festival2023/exhibition/indexTabD.jsp" %>
				</div>
			</c:when>
		</c:choose>
	</form:form>
