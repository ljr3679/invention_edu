							...
							<div class="info_slide_cont">
								<ul id="info_slide" class="info_slide">
									<li>
										<div class="img_box">
											<div class="inner_box">
												<img src="/images/home/kor/user/award/festival2021/aug_01.jpg" alt="증강현실 콘텐츠(AR 보물찾기) 체험 사진 1번째" />
											</div>
										</div>
									</li>
									<li>
										<div class="img_box">
											<div class="inner_box">
												<img src="/images/home/kor/user/award/festival2021/aug_02.jpg" alt="증강현실 콘텐츠(AR 보물찾기) 체험 사진 2번째" />
											</div>
										</div>
									</li>
									<li>
										<div class="img_box">
											<div class="inner_box">
												<img src="/images/home/kor/user/award/festival2021/aug_03.jpg" alt="증강현실 콘텐츠(AR 보물찾기) 체험 사진 3번째" />
											</div>
										</div>
									</li>
									<li>
										<div class="img_box">
											<div class="inner_box">
												<img src="/images/home/kor/user/award/festival2021/aug_04.jpg" alt="증강현실 콘텐츠(AR 보물찾기) 체험 사진 4번째" />
											</div>
										</div>
									</li>
								</ul>
