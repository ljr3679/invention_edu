...
<form:form commandName="commonVO" name="cmmnForm" id="cmmnForm" method="post">
	...
	<input type="hidden" id="searchValue5" name="searchValue5"/>
	<div class="sub_sch_box">
		...
		<div class="row">
			<label for="searchKeyword">협력기관</label>
			<div class="input_box">
					...
					<td>
						<c:choose>
							<c:when test="${not empty list.attachName}">
								<a style="cursor: pointer;" href="javascript:void(0);" onclick="cmmn_file_down('${list.attachName}','${list.attachReName}')">
