...
<div class="com_cont ft_c3">
	<div class="ft_c1">
		<div class="title_cont">
			<div class="box">
				<div class="img_box">
					<img src="/images/home/kor/user/award/festival2022/tit_area_bg_01.jpg" alt="">
				</div>
		...
		<div class="info_list_cont">
			<ul class="list">
				...
				<li>
					<div class="box">
						<div class="title">2022 YIP 교육과정</div>
								...
								<ul class="step_list">
									...
									<li class="bg02">
										<div class="box">
											...
											<div class="text_box">
												<div class="text_box_inner">
													<div class="text"> OT 집중교육</div>
													<div class="day">7-8월</div>
												</div>
											</div>
										</div>
									</li>
									...
									<li class="bg02">
										<div class="box">
											...
											<div class="text_box">
												<div class="text_box_inner">
													<div class="text">지재권 출원 및 <br>등록 지원</div>
													<div class="day">11월</div>
												</div>
											</div>
										</div>
					...
					<div class="award-list-wrap">
						...
						<a href="javascript:void(0);" onclick="fn_view('A');" class="award_block">
							<div class="emblem_area gold">
								<img src="/images/home/kor/user/award/festival2022/emblem_gold.png" alt="">
							</div>
							<div class="img_area">
								<span class="img_inner" style="background-image: url(/images/home/kor/user/award/festival2022/yip_img01.png);">이미지영역</span>
							</div>
						...
						<a href="javascript:void(0);" onclick="fn_view('B');" class="award_block">
							<div class="emblem_area gold">
								<img src="/images/home/kor/user/award/festival2022/emblem_silver.png" alt="">
							</div>
							<div class="img_area">
								<span class="img_inner" style="background-image: url(/images/home/kor/user/award/festival2022/yip_img02.png);">이미지영역</span>
							</div>
							<div class="award_info_area">
						...
						<a href="javascript:void(0);" onclick="fn_view('C');" class="award_block">
							...
							<div class="img_area">
								<span class="img_inner" style="background-image: url(/images/home/kor/user/award/festival2022/yip_img03.png);">이미지영역</span>
							</div>
							<div class="award_info_area">
								<div class="label">최우수상</div>
						...
						<a href="javascript:void(0);" onclick="fn_view('D');" class="award_block">
							...
							<div class="img_area">
								<span class="img_inner" style="background-image: url(/images/home/kor/user/award/festival2022/yip_img04.png);">이미지영역</span>
							</div>
							<div class="award_info_area">
								<div class="label">최우수상</div>
						...
						<a href="javascript:void(0);" onclick="fn_view('E');" class="award_block">
							...
							<div class="img_area">
								<span class="img_inner" style="background-image: url(/images/home/kor/user/award/festival2022/yip_img05.png);">이미지영역</span>
							</div>
							<div class="award_info_area">
								<div class="label">최우수상</div>
