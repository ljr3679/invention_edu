...
<table class="board_write basic">
	...
	<tbody>
		...
		<%-- <tr>
			...
			<td>
				<input type="radio" id="paramKey3_1" name="paramKey3" <c:if test="${resultData.typeAt eq 'A' or vo.act eq 'regist'}">checked="checked"</c:if> value="A" vali-text="구분을 선택해주세요."><label style="margin-left: 10px" for="paramKey3_1">발명교육포털사이트</label>
                <input type="radio" id="paramKey3_2" name="paramKey3" <c:if test="${resultData.typeAt eq 'B'}">checked="checked"</c:if> value="B" vali-text="구분을 선택해주세요."><label style="margin-left: 10px" for="paramKey3_2">대한민국학생발명전시회</label>
                <input type="radio" id="paramKey3_3" name="paramKey3" <c:if test="${resultData.typeAt eq 'C'}">checked="checked"</c:if> value="C" vali-text="구분을 선택해주세요."><label style="margin-left: 10px" for="paramKey3_3">대한민국 학생창의력 챔피언대회</label>
                <input type="radio" id="paramKey3_4" name="paramKey3" <c:if test="${resultData.typeAt eq 'D'}">checked="checked"</c:if> value="D" vali-text="구분을 선택해주세요."><label style="margin-left: 10px" for="paramKey3_4">YIP(Young Invenfors Program)</label>
			</td>
		</tr> --%>
		<tr>
			<th scope="row">제목</th>
