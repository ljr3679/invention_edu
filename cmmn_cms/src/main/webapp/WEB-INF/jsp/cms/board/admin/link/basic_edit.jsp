...
<form:hidden path="searchKeyword"/>
	...
	<table class="board_write basic">
		...
		<tbody>
			...
			<tr>
				<th scope="row">링크 새창여부</th>
				<td>
					<input type="radio" id="paramKey50_1" name="paramKey50" value="Y" vali-text="링크 새창여부를 선택해주세요." <c:if test="${empty resultData.blankYn or resultData.blankYn eq 'Y'}">checked="checked"</c:if>/><label for="paramKey50_1">새창</label>
					<input type="radio" id="paramKey50_2" name="paramKey50" value="N" vali-text="링크 새창여부를 선택해주세요." <c:if test="${resultData.blankYn eq 'N'}">checked="checked"</c:if>/><label for="paramKey50_2">현재창</label>
				</td>
			</tr>
