...
<div class="bread_box bg03">
	<div class="container">
		<div class="title_area">
			<div class="title">
				<span class="text">대한민국 학생창의력 <span>챔피언대회</span></span>
			</div>
		</div>
		<ul class="breadcrumb clearfix">
			<li class="home"><a href="/home/kor/award/festival2024/main.do?menuPos=1"><img src="/images/home/kor/user/award/common/home.png?t=20220907160759" alt="홈으로"></a></li>
			<li>
				대한민국 학생창의력 <span>챔피언대회</span>
			</li>
		</ul>
		<ul class="btn_list">
			<li class="share">
