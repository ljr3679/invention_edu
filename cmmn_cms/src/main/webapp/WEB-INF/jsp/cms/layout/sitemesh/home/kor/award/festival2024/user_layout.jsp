...
<head>
	...
	<%@ include file="/WEB-INF/jsp/cms/layout/sitemesh/home/kor/award/festival2024/include/user/inc_css.jsp" %>
	<%@ include file="/WEB-INF/jsp/cms/layout/sitemesh/home/kor/award/festival2024/include/user/inc_js.jsp" %>
	...
	<c:choose>
		...
		<c:otherwise>
			...
			<c:if test="${vo.tabPos ne '1'}">
				<link rel="stylesheet" href="/css/home/kor/user/award/festival2024/sub.css">
				<link rel="stylesheet" href="/css/home/kor/user/award/festival2024/sub_respond.css">
...
<div class="wrapper">
	<header>
		<%@ include file="/WEB-INF/jsp/cms/layout/sitemesh/home/kor/award/festival2024/include/user/inc_header.jsp" %>
	</header>
	<c:choose>
		...
		<c:otherwise>
			<c:choose>
				<c:when test="${vo.tabPos eq '1'}">
					<%@ include file="/WEB-INF/jsp/cms/layout/sitemesh/home/kor/award/festival2024/include/user/inc_sub_top1.jsp" %>	
				</c:when>
				<c:when test="${vo.tabPos eq '2'}">
					<%@ include file="/WEB-INF/jsp/cms/layout/sitemesh/home/kor/award/festival2024/include/user/inc_sub_top2.jsp" %>	
				</c:when>
				<c:when test="${vo.tabPos eq '3'}">
					<%@ include file="/WEB-INF/jsp/cms/layout/sitemesh/home/kor/award/festival2024/include/user/inc_sub_top3.jsp" %>	
				</c:when>
				<c:when test="${vo.tabPos eq '4'}">
					<%@ include file="/WEB-INF/jsp/cms/layout/sitemesh/home/kor/award/festival2024/include/user/inc_sub_top4.jsp" %>	
				</c:when>
				<c:when test="${vo.tabPos eq '5'}">
					<%@ include file="/WEB-INF/jsp/cms/layout/sitemesh/home/kor/award/festival2024/include/user/inc_sub_top5.jsp" %>	
				</c:when>
			</c:choose>
			<c:choose>
				<c:when test="${vo.tabPos eq '1'}">
	...
	<%@ include file="/WEB-INF/jsp/cms/layout/sitemesh/home/kor/award/festival2024/include/user/inc_footer.jsp" %>
