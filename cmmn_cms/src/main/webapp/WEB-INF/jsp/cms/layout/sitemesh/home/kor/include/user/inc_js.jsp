...
<script type="text/javascript" src="/js/home/kor/user/swiper.min.js"></script>
<script type="text/javascript" src="/js/home/kor/user/jquery.mCustomScrollbar.concat.min.js"></script>
<script type="text/javascript" src="/js/home/kor/user/analytics.js"></script>
<script type="text/javascript" src="/js/home/kor/user/webfont.js"></script>
	
<!-- calendar -->
<script type="text/javascript" src="/js/home/kor/user/board-calendar-datepicker.js"></script>
<script type="text/javascript" src="/js/home/kor/user/bootstrap-datepicker.js"></script>	
...
<script type="text/javascript">
	WebFont.load({
	    ...
	    custom: {
	        families: ['CoreDream'],
	        urls: ['/css/home/kor/user/CoreDream.css']
	    }
	});
