...
<script type="text/javascript" defer="defer">
	...
	$('.add_config').on('click', function() {
		...
		if(name) $('#config_body').append(getConfigHtml(name));
	...
	<table class="board_write basic">
		...
		<tbody>
			...
			<tr>
				...
				<td colspan="3">
					<input id="title" name="title" type="text" style="width: 30%;" vali-text="게시판 이름을 입력하여 주십시오." maxlength="100" value="${resultData.title}" />
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="3">
					<table class="board_write basic">
						...
						<tr>
							<th scope="row" style="width:17%">카테고리</th>
							<td>
								<input class="unCheck" id="paramKey6" name="paramKey6" type="text" style="width: 100%;" value="${resultData.category}" placeholder="게시판에 카테고리가 필요하신경우 '^' 구분으로 입력해주세요." />
							</td>
						</tr>
