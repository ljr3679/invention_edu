...
<html lang="ko">
  ...
  <body class="container">
    ...
    <article class="question" style="display:block;">
      ...
      <h2 id="title" class="questionMain">어떤 유형의 자료를 원하시는지요?</h2>
      ...
      <div>
      	<button id="down" type="button"  class="btn btn_select" onclick="answer3();">
      	  각종 대회 참여
      	</button>
      </div>
      <div>
      	<button id="down" type="button"  class="btn btn_select" onclick="answer4();">
      	  교사 연구 대회
      	</button>
      </div>            
    </article>
    ...
    <script>
      ...
      function answer1() {
        location.href='./result21.jsp';
      }    
      function answer2() {
        location.href='./result22.jsp';
      }
      function answer3() {
        location.href='./result23.jsp';
      }
      function answer4() {
        location.href='./result24.jsp';
      }      
    </script> 
