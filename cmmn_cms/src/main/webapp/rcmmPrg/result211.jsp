...
<body class="container">
			...
			<div>
				<article class="result" style="display:block;">
					...
					<div class="scroll_box">
						<div class="resultbox">
							<h5 class="resultcontent" id="workexplain" name="추천 프로그램">연수 안내</h5>
						...
						<div class="resultbox">
							<h5 class="resultcontent" id="workexplain" name="추천 프로그램">연구회 안내</h5>
	...
	<script>
		...
		function go2() {
			window.open('https://ip-edu.net/home/kor/contents.do?menuPos=106');
		}
