			...
			<div>
				<article class="result">
					...
					<div class="scroll_box">
						<div class="resultbox">
							<h5 class="resultcontent" id="workexplain" name="추천 프로그램">YIP</h5>
						...
						<div class="resultbox">
							<h5 class="resultcontent" id="workexplain" name="추천 프로그램">마이스터</h5>
						...
						<div class="resultbox">
							<h5 class="resultcontent" id="workexplain" name="추천 프로그램">직업계고 발명특허교육</h5>
						...
						<div class="resultbox">
							<h5 class="resultcontent" id="workexplain" name="추천 프로그램">차세대 영재기업인</h5>
