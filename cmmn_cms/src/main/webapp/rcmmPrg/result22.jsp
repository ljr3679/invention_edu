...
<body class="container">
			...
			<div>
				<article class="result" style="display:block;">
					...
					<div class="scroll_box">
						<div class="resultbox">
							<h5 class="resultcontent" id="workexplain" name="추천 프로그램">프로그램 안내</h5>
							<div>진흥회가 추천하는 프로그램을 안내해 드립니다. </div>
							<div>
						...
						<div class="resultbox">
							<h5 class="resultcontent" id="workexplain" name="추천 프로그램">발명 교육 컨텐츠 공유</h5>
	...
	<script>
		function go1() {
			window.open('https://ip-edu.net/home/kor/contents.do?menuPos=108');
		}

		function go2() {
			window.open('https://ip-edu.net/home/kor/contents.do?menuPos=101');
		}
