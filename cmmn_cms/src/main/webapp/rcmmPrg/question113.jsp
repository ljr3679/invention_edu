...
<html lang="ko">
  ...
  <body class="container">
		...
		<div class="view">
			<div>
			    <article class="question" style="display:block;">
			      ...
			      <h2 id="title" class="questionMain">관심있는 분야는 무엇인가요?</h2>
			      ...
			      <div>
			      	<button id="down"  class="btn btn_select" type="button" onclick="answer4();">
			      	  창의발명인재 양성프로그램
			      	</button>
			      </div>  			      
			    </article>
    ...
    <script>
      ...
      function answer1() {
        location.href='./result131.jsp';
      }    
      function answer2() {
        location.href='./result112.jsp';
      }
      function answer3() {
        location.href='./result113.jsp';
      }   
	  function answer4() {
        location.href='./result134.jsp';
      }  
    </script> 
